            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="bd-hero-text">
                        ...
                        <h2><textarea class="insert_textarea_from" name="title_name" rows="1" cols="20" style="width:100%; text-align: center" required="required" data-lang="title">${vo1.title_name }</textarea></h2>
                        <ul>
                            <li class="b-time"><i class="icon_clock_alt"></i> <input type="date" name="write_date" value="<%=sf.format(nowTime)%>"></li>
                            <li><i class="icon_profile"></i> <textarea class="insert_textarea_from" name="writerOnEvnet" rows="1" cols="15" style=" vertical-align: middle; text-align: center;" required="required" data-lang="manager">${vo1.writerOnEvnet }</textarea></li>
                        </ul><br><br><br>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-text">
                        <div class="bd-title">
                            <textarea class="insert_textarea_from" name="prologOnevnet" rows="20" cols="115" style="width:100%" data-lang="add_prologue">${vo1.prologOnevnet }</textarea>
                        </div>
                        <div class="bd-pic">
                        ...
                        <div class="bd-more-text">
                            <div class="bm-item">
                                <h4><textarea class="insert_textarea_from" name="subTitleOnEvnet" rows="1" cols="71" style="width:100%" data-lang="subtitle">${vo1.subTitleOnEvnet }</textarea></h4>
                                <textarea class="insert_textarea_from" name="textOnsubTitle" rows="20" cols="115" style="width:100%" data-lang="add_contents">${vo1.textOnsubTitle }</textarea>
                            </div>
 							<div align="center">
